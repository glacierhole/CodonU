...
# 确定密码子打分表
suzhucodon = "codonset.txt"
st.title(f"这是一个{suzhu}宿主的密码子偏好性预测程序")
st.write("作者：饶一率")
st.write("时间：2023-09-16")
st.write("""## 物种信息""")
st.write(f"{suzhu}基因组编码基因来源：[NCBI](https://www.ncbi.nlm.nih.gov/datasets/genome/?taxon=543736)")
st.write(f"选择GCA_020542785.1来进行统计得到{suzhu}密码子打分表")
